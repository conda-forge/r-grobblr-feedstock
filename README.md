...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-grobblr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10160&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-grobblr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-grobblr` can be installed with:

```
conda install r-grobblr
```

It is possible to list all of the versions of `r-grobblr` available on your platform with:
